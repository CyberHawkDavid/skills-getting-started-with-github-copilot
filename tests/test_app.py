...
def test_signup_without_email_is_rejected(client):
    # Arrange
    endpoint = "/activities/Soccer Team/signup"
...
def test_unregistering_from_unknown_activity_is_rejected(client):
    # Arrange
    activity_name = "Unknown Activity"
    email = "student@mergington.edu"
...
def test_unregister_allows_participant_to_sign_up_again(client):
    # Arrange
    activity_name = "Chess Club"
    email = activities[activity_name]["participants"][0]
